      ...
      <Modal isOpen={isModalOpen} className={'tw-w-[60%] tw-rounded-md border tw-border-gray'} onClose={closeModal}>
        ...
        <div className="">
          ...
          <div className=" p-4 tw-rounded-md">
           ...
           <h6 className=" tw-text-gray  tw-font-normal  tw-text-[13px]  ">The first appointment is free for students and EU Citizens who are not yet relocated to Sweden. The one-hour appointment session consists of three phases: Background Information, Assessment of Issues/Problems, and Possible Solutions. </h6>
          ...
          <ul className=" tw-p-0  tw-pt-2">
            ...
            <li className="">
                ...
                <h6 className=" tw-text-gray  tw-font-normal  tw-text-[13px]  ">Paid appointments can be rescheduled if necessary.
                </h6>
            ...
            <li className="">
                <p className=" tw-text-sm  tw-text-gray">4-In some cases we will provide a promo code to upload documents, view service charges, and book a free appointment.
                </p>
                

            </li>
            <li className="">
                <p className=" tw-text-sm  tw-text-gray">5-It is important to include basic information in the description box while booking an appointment.
                </p>
                

            </li>
            <li className="">
                <p className=" tw-text-sm  tw-text-gray">6-For any technical issues during the booking process, please contact customer support via message section or call <Link>0046723276276</Link> during the working hours.
                </p>
