           ...
           <div className="row g-5">
              ...
              <div className=" tw-shadow-lg">
                ...
                <div className="post-header">
                  ...
                  <div className="  tw-flex tw-gap-2 tw-items-center">
                    ...
                    <p className=" tw-text-gray m-0">  <i class="fa fa-calendar-check"></i> 2024-07-06</p>
                  </div>
            ...
            <div className="col-md-4   tw-bg-[#F5FAFF]">
              ...
              <h5 className="  ">Meta</h5>
                ...
                <ul className=" tw-p-0">
                  <li className=" tw-gap-2 tw-flex tw-items-center"> <LiaAngleRightSolid className=" tw-text-sm"  /> <p className=" tw-m-0 tw-text-black tw-pt-2">Log in</p></li>
                  <li className=" tw-gap-2 tw-flex tw-items-center">  <LiaAngleRightSolid className=" tw-text-sm"  /> <p className=" tw-m-0 tw-text-black tw-pt-2">Entries-feed</p></li>
                  <li className=" tw-gap-2 tw-flex tw-items-center"> <LiaAngleRightSolid  className=" tw-text-sm"  /> <p className=" tw-m-0 tw-text-black tw-pt-2">Comments feed</p></li>
                  <li className=" tw-gap-2 tw-flex tw-items-center"> <LiaAngleRightSolid className=" tw-text-sm" /> <p className=" tw-text-black tw-pt-2">WordPress.org</p></li>
                </ul>
              </div>
              </div>
            </div>
