                ...
                <form>
                  <div className="row g-3">
                    <div className="col-md-6">
                      <Input  placeholder={'Your Name'} type={'text'} className={' tw-bg-[#F5FAFF]   tw-w-full tw-py-3 tw-rounded-none'} />
                    </div>
                    <div className="col-md-6">
                    <Input  placeholder={'Your Name'} type={'text'} className={' tw-bg-[#F5FAFF]   tw-w-full tw-py-3 tw-rounded-none'} />
                    </div>
                    <div className="col-md-6">
                    <Input  placeholder={'Phone Number'} type={'text'} className={' tw-bg-[#F5FAFF]   tw-w-full tw-py-3 tw-rounded-none'} />
                    </div>
                    <div className="col-md-6">
                    <Input  placeholder={'Subject'} type={'text'} className={' tw-bg-[#F5FAFF]   tw-w-full tw-py-3 tw-rounded-none'} />
                    </div>
                    <div className="col-md-12">
                      <textarea rows={6} className="tw-bg-[#F5FAFF]   tw-w-full"></textarea>
                    </div>
                    <div className="col-md-12">
