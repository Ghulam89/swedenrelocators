        ...
        <div className="container tw-py-5">
          <div className="row">
            <div className="col-md-12">
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>3.1 </strong> One-time invoices for assignments or
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>3.2</strong> For those clients who choose the complete
                relocation package with multiple services we do have a special
                invoice and in that case they can pay us in 2 different
                installments.
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>3.3</strong>In some cases, we will request advance
                payment before starting the process. Those clients who are
                availing our services from outside of Sweden. The total amount
                of our fee for the assignment can become higher or lower than
                the advance amount if you added any extra services where we
                consume more time and effort.
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>3.4</strong>At The latest you have to pay the invoice is
                30 days after the invoice date. Then after one reminder invoice
                was forwarded to our partner Inkasso company. The first invoice
                will be issued from the company and you can see it under your ”
                Payment” section on My Page. All other invoices will be issued
                through, Visma or Profina.
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>3.5</strong>We will not charge a late payment for
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>3.6</strong>You can find all your documents,
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>4.1 </strong> For certain assignments, we must collect
                and maintain satisfactory evidence of the identity of the
                applicant. Therefore, we may ask you to provide us with your
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>4.2</strong> For Family relocation services we will keep
                all the family documents, which we might need in the future to
                communicate to the authorities on your behalf.
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>4.3</strong>On our online portal you can upload all the
                relevant documents which we required in your application
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>4.4</strong>We will only provide ongoing assignment or
                application information to the person who has signed the
                Fullmakt(Power of Attorney) or his/her spouse in some cases. We
                always update the application status for all ongoing
                applications and we will recommend you to please check your
                online portal.
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>4.5</strong>According to the new GDPR law we inform each
                client that we are going to keep your data, information,
                documents until your assignment is completed. You can even
                delete your profile and all the given information data will be
                disappeared in 72 Hours. You can even request us to delete your
                data but keep the profile for the latest updates.
              </p>
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>5.1 </strong> When we advise you so it is specific to
                your assignment and the facts and background information we
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>5.2</strong>Our advisors can only advise on the business
                conditions in real-time, Policies laws can be changed at any
                time by sudden or planned interruption, amendments so the
                company or individual or partner will be not responsible for any
                advice which has been given in the past.
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>5.3</strong>We will not record any audio video during
                the advising, like during the appointment session, and it’s
                strictly prohibited. If we found any sort of audio/video clip or
                any other pieces of information which been taken without our
                knowledge company will take immediate action under the defined
                section in Laws. In some cases, if you need it for a specific
                purpose you need written approval from the company.
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>5.4</strong>We are not lawyers but consultants and can
                advise you according to available information on the
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>6.1 </strong> In addition to the limitations of
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>6.2</strong>Once we got the Power of Attorney(Fullmakt)
                we suppose to communicate on your behalf, you are not allowed to
                communicate yourself further without informing us. In that case,
                we will charge our fee as usual and will not be responsible for
                any further proceedings.
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>6.3</strong>We advise our clients according to their
                current circumstances. We are not responsible for any changes
                made after that date by the Government authorities. (5.1 Laws,
                Policies)
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>6.4</strong>We would not be answerable to any other
                person except the client who signed the Power of Attorney with
                SWEDEN RELOCATORS AB. We will not be responsible for the
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>6.5</strong>No time frame will be provided by us, We
                tell you what waiting time will be mentioned on the authority’s
                website. According to administration laws, all decisions must be
                made within 6 months but it can be more time-taking as well.
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>6.6</strong>We are using an online portal and using an
                international server for the database storage, we have already
                made all the security features active for your uploaded,
