  ...
  return (
    <>
            ...
            <div className="row g-4">
              <div className="col-md-8 tw-py-20 tw-bg-white">
                <div className="  md:tw-px-20 tw-px-2">
                  ...
                  <div>
                    <span>RESIDENCE PERMIT FOR

</span>
                    <h2>
                      <strong>A Parent Or Other Family Member
</strong>
                    </h2>

                    <p className=" tw-text-gray">
                    The citizen of a Non- EU country who wants to move to a family member in Sweden, need a residence permit. In exceptional cases, it is possible to get a residence permit to move to a family member in Sweden or is not already or going to be your husband, wife or cohabiting partner. The family member in Sweden must have a permanent residence permit.
     ...
     <span>PARENTS OF
                    ...
                    <h2>
                      <strong>Children Under 18 Years
