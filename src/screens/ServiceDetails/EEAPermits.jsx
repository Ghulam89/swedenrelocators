            ...
            <div className="row g-4">
              <div className="col-md-8 tw-py-20 tw-bg-white">
                <div className="  md:tw-pl-32 tw-pl-3">
                  ...
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>EEA</span>
                  <h2>
                  ...
                  <p className=" tw-text-gray">
                    You can get refused when entering the UK without a permit.
                    You can apply for the EU card which is valid for 5 years,
                    once you are in the UK. The residence card makes it easier
                    for a person to work in the UK. However, The extended family
                    has to apply for a residence card.
                  </p>
                  ...
                  <div>
                    ...
                    <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>HOW TO QUALIFY FOR THE</span>
                    <h2>
                  ...
                  <div>
                    <div>
                      ...
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>WHO IS A</span>
                      <h2>
                    ...
                    <div>
                      ...
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>EXTENDED</span>
                    ...
                    <div>
                      ...
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>DERIVATIVE</span>
                      <h2>
                    ...
                    <div>
                      ...
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>RETAINED</span>
                      <h2>
                        <strong>Right Of Residence</strong>
                      </h2>
                    ...
                    <div>
                      ...
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>YOU CAN RECEIVE A RETAINED</span>
                      <h2>
                        <strong>
                    ...
                    <div>
                      ...
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>SPECIFIC REQUIREMENTS</span>
                      <h2>
