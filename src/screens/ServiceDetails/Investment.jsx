              ...
              <div className="col-md-8 tw-py-20 tw-bg-white">
                <div className="  md:tw-px-20 tw-px-2">
                  ...
                  <p className=" tw-text-gray">
                    ...
                    company and a business person has to do everything on his
                    own. Investment opportunities can be of both type and it is
                    your own choice whether you want to start your own new
                    business or want to get a franchise.There are various
                    opportunities for business ventures in Sweden and you should
                  ...
                  <p className=" tw-text-gray">
                    ...
                    efficient nation worldwide, transporting goods and linking
                    manufacturers and consumers with international markets. A
                    fundamental aspect of the Swedish economy is its open and
                    liberal approach to doing business. The country offers a
                    globalized business environment that makes it easy for
                    overseas organizations to work within. Accomplished
                    professionals, sophisticated business procedures and
                    receptiveness to international partnerships allow an
                  ...
                  <p className=" tw-text-gray">
                    ...
                    innovation clusters and vibrant startup scene, international
                    companies can accelerate their journey to a connected,
                    low-carbon future.
                  </p>
                  ...
                  <p className=" tw-text-gray">
                    ...
                    have broken into major consumer markets abroad such as the
                    US and China. Meanwhile, Sweden’s AgTech sector has rapidly
                    expanded. Collaboration initiatives are ramping up to shape
                    tomorrow’s agriculture by introducing sensors, artificial
                    intelligence, Internet of Things and other digital
                    technologies that will optimise food production and
                    harvests. There are at least 20 startups today in the AgTech
                    sector, several of which are addressing global challenges in
