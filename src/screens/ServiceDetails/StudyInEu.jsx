              ...
              <div className="col-md-8 tw-py-20 tw-bg-white">
                <div className="  md:tw-pl-32 tw-pl-3">
                  ...
                  <div>
                    ...
                    <p className="  tw-text-gray">You will need to take an admission test and an interview if required by the course. So it will be advised for some early preparation
</p>
