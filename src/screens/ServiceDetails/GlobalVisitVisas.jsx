...
<span className=" tw-flex tw-items-center tw-gap-2"> <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p> IF YOU WANT</span>
                  ...
                  <ul className=" tw-p-0 tw-pt-4">
                    ...
                    <p className=" tw-text-gray">You can apply for a visit visa directly from our <Link to={'https://globalvisa.eu/'}>website.</Link>

</p>
                  

                  <p className="  tw-text-gray tw-pt-4">For visiting Sweden for a short period you will need a visit visa . Visiting for a short tour, meeting your relatives, visiting friends or business meeting you need to consider short visit to Sweden which is as Schengen tourist visa Sweden follows the same visa rules as other European country because it is also the part of Schengen agreement.
